...
<body>
        ...
        <div id="yeucauvattu">
            ...
            <form id="input" autocomplete="off" action="#" method="post">
                ...
                <div id="trai">
                    ...
                    <!-- onkeyup="myFunction()" onkeydown="myFunction()" onkeypress="myFunction()" onchange="myFunction()" onselect="myFunction()" onmousedown="myFunction()" onmouseout="myFunction()" onmouseover="myFunction()" onmousemove="myFunction()" onmouseup="myFunction()"  -->
                    <p>
                    <div class="autocomplete" style="width: 100%;">
                        <label id="text">Vật tư: <span style="color:red">*</span></label>
                        <input id="txtVatTu" name="VatTu" onchange="myFunction()">
                    </div>
                    </p>
                    <p>
                ...
                <div id="phai">
                    ...
                    <p>
                        ...
                        <select id="cboketoan" name="choice" placeholder="">
                            <?php
                            // $db=mysqli_connect('10.40.13.29','root','','chukyso');
                            $bp = mysqli_query($connect, "SELECT * FROM `nhanvien` WHERE (IDChucVu LIKE '%CV0023%' AND IDBoPhan='D0010') or (IDChucVu LIKE '%CV0033%' AND IDBoPhan='D0010')")
                                or die("Kết nối tới máy chủ thất bại, vui lòng quay lại sau." . mysqli_error($connect));
                ...
                <div class="w3-container">
                    <div class="table-responsive" style="min-height: 400px;font-family: Arial;font-size: 17px;TEXT-ALIGN: -WEBKIT-CENTER;">
                        ...
                        <div style="font-weight: bold;font-size: 20px;text-align: center;">
                            BẢNG TỔNG HỢP NHU CẦU SỬ DỤNG VẬT TƯ THÁNG <span id="monthh"></span> NĂM <span id="yearr"></span>
                            <br />
                            ---oOo---
                        </div>
                        <br>
    ...
    <script>
        ...
        userduyet = arry_nguoiduyet3[1];
				...
				var monthh = todate.getMonth() + 2;
				if(monthh>=13){
					$('#monthh').text(1);
					var yearr = todate.getFullYear()+1;
					$('#yearr').text(yearr);
				}
				else{
					$('#monthh').text(monthh);
					var yearr = todate.getFullYear();
					$('#yearr').text(yearr);
				}
        ...
        function ajaxx(vattus){
            var arry_nguoiduyet1 = $('#cbotaoduyet').val().split(" - ");
            var nguoiduyet1 = arry_nguoiduyet1[0];
            var usertd = arry_nguoiduyet1[1];


            var arry_nguoiduyet2 = $('#cboketoan').val().split(" - ");
            var nguoiduyet2 = arry_nguoiduyet2[0];
            userkt = arry_nguoiduyet2[1];


            var arry_nguoiduyet3 = $('#cboduyet').val().split(" - ");
            var nguoiduyet3 = arry_nguoiduyet3[0];
            userd = arry_nguoiduyet3[1];
            var user={usertd, userkt, userd};
