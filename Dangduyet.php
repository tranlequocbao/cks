...
if ($row5['IDNhomQuyen'] == 02 ) {
    $query1 = "SELECT DISTINCT phieu.IDPhieu,nhanvien.HoTenNhanVien,loaiphieu.TenLoaiPhieu,phieu.NgayTao,loaiphieu.VietTat, pheduyet.DaDuyet
      ...
      and nhanvien.IDNhanVien='$ID' 
      AND phieu.IDPhieu NOT IN 
          (SELECT DISTINCT phieu.IDPhieu
          from phieu,nhanvien,loaiphieu,pheduyet,caidatmau 
          WHERE phieu.IDLoaiPhieu=loaiphieu.IDLoaiPhieu 
          and phieu.IDPhieu=pheduyet.IDPhieu 
          and phieu.IDLoaiPhieu=caidatmau.IDLoaiPhieu 
      ...
      LIMIT $start, $limit";
    $query = "SELECT DISTINCT phieu.IDPhieu,nhanvien.HoTenNhanVien,loaiphieu.TenLoaiPhieu,phieu.NgayTao,loaiphieu.VietTat, pheduyet.DaDuyet
      from phieu,nhanvien,loaiphieu,pheduyet,caidatmau
      WHERE phieu.IDLoaiPhieu=loaiphieu.IDLoaiPhieu 
      and phieu.IDPhieu=pheduyet.IDPhieu 
      and phieu.IDLoaiPhieu=caidatmau.IDLoaiPhieu 
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h6 class="card-title" style="font-weight: bold;">HỒ SƠ ĐANG DUYỆT</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    ?>
                                        <tbody id="table_han">
                                            <tr>
                                                ...
                                                <td style="color: yellow;">ĐANG DUYỆT</td>
                                                <td>
