...
<body>
    ...
    <div id="content">
        <div id="yeucauvattu">
            ...
            <?php
            $infomation = "SELECT * FROM yeucauvpp,nhanvien,bophan, vattu WHERE yeucauvpp.IDNhanVien=nhanvien.IDNhanVien AND yeucauvpp.IDBoPhan=bophan.IDBoPhan AND yeucauvpp.IDPhieu='$idphieu' AND vattu.IDVatTu=yeucauvpp.IDVatTu";
            ...
            <div id="noidung" style="width: 90%; margin: auto;">
                ...
                <table id="duyet" style="border: none; width:100%">
                    <tr>
                    ...
                    <form action="" method="post">
                        <tr>
                            <?php
                            $duyet1 = "SELECT * FROM pheduyet WHERE pheduyet.MucDuyet=1 AND pheduyet.IDPhieu='" . $idphieu . "'";
                            $query1 = mysqli_query($connect, $duyet1);
                            $row1 = mysqli_fetch_assoc($query1);
                            $daduyet1 = $row1["DaDuyet"];
                            $ngayduyet1 = $row1["NgayDuyet"];
                            $nhanxet1 = $row1["GhiChu"];
                            $duyet2 = "SELECT * FROM pheduyet WHERE pheduyet.MucDuyet=2 AND pheduyet.IDPhieu='" . $idphieu . "'";
                            $query2 = mysqli_query($connect, $duyet2);
                            $row2 = mysqli_fetch_array($query2);
                            $ngayduyet2 = $row2["NgayDuyet"];
                            $daduyet2 = $row2["DaDuyet"];
                            $nhanxet2 = $row2["GhiChu"];
                            $duyet3 = "SELECT * FROM pheduyet WHERE pheduyet.MucDuyet=3 AND pheduyet.IDPhieu='" . $idphieu . "'";
                            ...
                            ?>
                                    ...
                                    <td style="width: 25%; border: none; text-align: center; height:60px"></td>
                                    <td class="txtXemXet" style="width: 25%; border: none; text-align: center; height:60px">
                                ...
                                <td style="width: 25%;border: none;text-align: center;font-weight: bold;"></td>
                                <td class="txtXemXet" style="width: 25%;border: none;text-align: center;font-weight: bold;">
                    ...
                    <tr>
                        <td style="width: 25%;border: none;text-align: center;">
                            <?php
                            $duyet = "SELECT * FROM nhanvien,pheduyet WHERE pheduyet.MucDuyet=3 AND nhanvien.IDNhanVien=pheduyet.IDNhanVien AND pheduyet.IDPhieu='" . $idphieu . "'";
                        ...
                        <td style="width: 25%;border: none;text-align: center;"><?php
                                                                                $ketoan = "SELECT * FROM nhanvien,pheduyet WHERE pheduyet.MucDuyet=2 AND nhanvien.IDNhanVien=pheduyet.IDNhanVien AND pheduyet.IDPhieu='" . $idphieu . "'";
                        ...
                        <td class="txtXemXet" style="width: 25%;border: none;text-align: center;"><?php
                                                                                $taoduyet = "SELECT * FROM nhanvien,pheduyet WHERE pheduyet.MucDuyet=1 AND nhanvien.IDNhanVien=pheduyet.IDNhanVien AND pheduyet.IDPhieu='" . $idphieu . "'";
